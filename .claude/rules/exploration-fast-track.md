...
2. **Create folder** -- `mkdir -p explorations/[name]/{scripts,output}` + README + SESSION_LOG.md
3. **Code immediately** -- no plan needed. Must-haves: code runs, results correct, goal documented. Not needed: full docs, perfect style.
...
At any point: stop, archive with note ("Attempted X, hit blocker Y"), move on.
