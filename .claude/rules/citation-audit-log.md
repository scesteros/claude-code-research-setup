...
```markdown
| Chalfin2022policeforce | paper/sections/02_lit_review.tex:48 | mechanism for police force size effects partly via response time | BIB_OK | AMBIGUOUS | out_of_scope_inference | published | Paper estimates force-size effects on race-specific arrests; response-time mediation is not directly identified. | 2026-05-13 |  |
| Dell2015trafficking | paper/sections/02_lit_review.tex:64 | crackdowns on Mexican narcos raised local homicides | BIB_OK | VALID |  | published | Table 3 col (2): +27% homicide increase in PAN-victory municipalities 2007–2010 (close-elections RDD). | 2026-05-13 |  |
| Goldstein1985 | paper/sections/03_mechanism.tex:88 | raids reduce systemic violence by disrupting drug-market hierarchies | BIB_OK | MISMATCH | review_used_for_specific_finding | published | Paper defines the tripartite (psychopharmacological / economic-compulsive / systemic) framework. Does not establish that raids reduce systemic violence; that is downstream policy inference. | 2026-05-13 |  |
| BlanesIVidal2017response | paper/sections/02_lit_review.tex:51 | response-time elasticity of clearance, Greater Manchester PD | BIB_FAIL | INACCESSIBLE | wrong_authors |  | OpenAlex record at DOI 10.1086/691805 lists Blanes i Vidal & Kirchmaier, not Blanes i Vidal alone. Author list in references.bib missing co-author. Rewrote as BlanesIVidalKirchmaier2018. | 2026-05-13 |  |
| ChalfinMcCrary2017 | paper/sections/02_lit_review.tex:120 | police-on-crime elasticity ≈ -0.3 | BIB_OK | AMBIGUOUS | review_used_for_specific_finding | published | Paper is a survey; the -0.3 figure summarizes Chalfin 2013 and Mello 2019. Cite the primary papers for the specific magnitude. | 2026-05-13 | User: keep as additional cite alongside primary papers; clarify it is a survey. |
```
