...
|---|---|
| "Crackdowns on drug markets can raise local violence." | "Crackdowns on drug markets cause large increases in violence." (The source allows ambiguity; the paraphrase removes it.) |
| "The scraper identified ~50 raid events." | "The scraper identified exactly 50 / over 50 / fewer than 50 raid events." (Use what the source says.) |
| "Among four Latin American countries including Argentina." | "Argentina ranks first / second / among the highest." (The source does not rank.) |
| "We are not aware of recent quasi-experimental evaluations of CABA policing." | "There are no studies of CABA policing." (The hedge in the source is informative; preserve it.) |
| "Table 3, col 2: coefficient = -0.118 (SE 0.031), p < 0.01." | "Raids dramatically reduce homicides." (Source gives a magnitude and SE; paraphrase loses both and adds an adjective.) |
...
- A direct verbal attribution ("Dell (2015) finds that…",
  "Chalfin & McCrary (2017) survey…", "the regression in
...
- **From the literature:** "Goldstein (1985) introduces the tripartite
  framework" — attribute, do not assert as if it were a stylized
  fact.
...
- Suppose the source paper has two specs: a daily DiD and a monthly
  DiD.
- The daily DiD clusters at the barrio-day level.
- The monthly DiD clusters at the barrio-month level and uses a
  different control set.
- A paraphrase that says "the paper clusters at the barrio level and
...
- **First-mention specificity.** When paraphrasing a specific number
  ...
  scraped raid panel covers 51 events across 7 villas over 2016–2024
  (`<pipeline-output-path>/final_raid_panel.csv`)."*
...
- **Multi-study disambiguation in the literature.** *"Dell (2015,
